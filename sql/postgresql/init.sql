...
CREATE TABLE system_local_user
(
...
COMMENT ON TABLE system_local_user IS '系统用户表';
COMMENT ON COLUMN system_local_user.id IS '用户id';
COMMENT ON COLUMN system_local_user.username IS '用户名';
COMMENT ON COLUMN system_local_user.password IS '密码';
COMMENT ON COLUMN system_local_user.create_time IS '创建时间';
COMMENT ON COLUMN system_local_user.update_time IS '更新时间';
COMMENT ON COLUMN system_local_user.deleted IS '是否删除（false-未删除，true-已删除）';
COMMENT ON COLUMN system_local_user.creator IS '创建人';
COMMENT ON COLUMN system_local_user.updater IS '更新人';
