...
&emsp;[knowledge-base](https://github.com/NingNing0111/knowledge-base)是一款采用[RAG 技术](https://www.promptingguide.ai/zh/techniques/rag)实现的个人知识库 AI 问答系统，本项目适配 OpenAI 接口，因此可搭配[One-API](https://github.com/songquanpeng/one-api)实现大语言模型的统一调用。
...
- 基于自定义的ChatMessage实现`DatabaseChatMemory`将对话数据存储到数据库中；
